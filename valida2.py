...
# - MÓDULO DE VALIDACIÓN AVANZADO: Pearson por flujos + RMSE + CCC + F1-Score Cohortes.
...
if 'arranque_fase' not in st.session_state:
    st.set_page_config(page_title="PREDWEEM PERGAMINO vK4.9.8", layout="wide", page_icon="🌾")
...
# --- HEADER PRINCIPAL ---
st.title("🌾 PREDWEEM LOLIUM - PERGAMINO (BA) LAT = -33.89 LON = -60.57")
