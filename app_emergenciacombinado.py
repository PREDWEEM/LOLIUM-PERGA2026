...
# ---------------------------------------------------------
# 5. MOTOR DE CÁLCULO (LÓGICA INTEGRADA vK4.5)
# ---------------------------------------------------------
if df is not None and modelo_ann is not None:
    ...
    # --- C. RESTRICCIÓN HÍDRICA (LÓGICA SIGMOIDE Y DINÁMICA - PERGAMINO) ---
    ...
    # 🌧️ NUEVA REGLA: Forzar pico de 1.0 frente a eventos puntuales de lluvia >= 40 mm
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        pd.DataFrame({
            'Configuracion': ['T_Base', 'T_Optima', 'T_Critica', 'Umbral_Pico', 'Hydric_Midpoint_mm'],
            'Valor': [t_base_val, t_opt_max, t_critica, umbral_er, 60]
