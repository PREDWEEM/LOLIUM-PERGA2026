...
with st.expander("📂 1. Datos del Lote", expanded=True):
    ...
    with col_rastrojo:
        with st.container(border=True):
            ...
            cobertura_pct = st.slider("Cobertura de Rastrojo en Suelo (%)", min_value=0, max_value=100, value=75, step=5)
...
umbral_termoinhibicion = st.sidebar.number_input("Umbral Termoinhibición (°C)", 15.0, 35.0, 21.0, 0.5)
