# -*- coding: utf-8 -*-
"""
Postproceso PREDWEEM — Pergamino.
...
Este archivo se ejecuta después de actualizar_meteo_pergamino.py dentro del workflow.
"""
...
ARCHIVOS.extend(sorted(Path("data/historico_pronosticos").glob("ecmwf_ifs_ens_025*.csv")))
