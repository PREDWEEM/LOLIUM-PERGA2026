# -*- coding: utf-8 -*-
# ===============================================================
# 🌾 PREDWEEM INTEGRAL vK4.9.5 — LOLIUM PERGAMINO 2026
# Actualización:
...
# - Mantenimiento de Restricción Hídrica Sigmoide (90mm) + Relajación Dinámica específica
# - NUEVO: Forzado de pico (EMERREL = 1.0) frente a lluvias >= 40 mm
...
# ---------------------------------------------------------
st.set_page_config(
    page_title="PREDWEEM PERGAMINO vK4.9.5",
    layout="wide",
    page_icon="🌾"
)
...
archivo_campo = st.sidebar.file_uploader("2. Campo (Validación Pergamino)", type=["xlsx", "csv"])

df_meteo_raw = load_data(archivo_meteo, "PERGAMINO")
...
if df_meteo_raw is not None and modelo_ann is not None:
    ...
    # --- RESTRICCIÓN HÍDRICA (LÓGICA SIGMOIDE Y DINÁMICA - PERGAMINO) ---
    ...
    # 🌧️ NUEVA REGLA: Forzar pico de 1.0 frente a eventos puntuales de lluvia >= 40 mm (Específico Pergamino)
    df.loc[df["Prec"] >= 40.0, "EMERREL"] = 1.0
    ...
    fig_risk.update_layout(
        ...
        title="Mapa de Intensidad de Riesgo (Pergamino)"
    )
    ...
    st.sidebar.download_button(
        ...
        output.getvalue(),
        "PREDWEEM_Integral_Pergamino_vK4_9_5.xlsx"
    )
